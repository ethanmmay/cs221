...
public class GridMonitorTest {
	...
	private boolean getSurroundingSumGrid4x5Test() {
		final double[][] expected = { { 9, 21, 24, 25, 20 }, { 20, 20, 31, 26, 23 }, { 17, 28, 29, 30, 25 },
				{ 17, 22, 30, 31, 28 } };
		final String testFile = "sample4x5.txt";
		boolean success = true;
	...
	private boolean getSurroundingAvgGrid4x5Test() {
		final double[][] expected = { { 2.25, 5.25, 6.0, 6.25, 5.0 }, { 5.0, 5.0, 7.75, 6.5, 5.75 },
				{ 4.25, 7.0, 7.25, 7.5, 6.25 }, { 4.25, 5.5, 7.5, 7.75, 7.0 } };
		final String testFile = "sample4x5.txt";
		boolean success = true;
	...
	private boolean getDeltaGrid4x5Test() {
		final double[][] expected = { { 1.125, 2.625, 3.0, 3.125, 2.5 }, { 2.5, 2.5, 3.875, 3.25, 2.875 },
				{ 2.125, 3.5, 3.625, 3.75, 3.125 }, { 2.125, 2.75, 3.75, 3.875, 3.5 } };
		final String testFile = "sample4x5.txt";
		boolean success = true;
	...
	private boolean getDangerGrid4x5Test() {
		final boolean[][] expected = { { true, false, false, false, false }, { false, true, false, false, false },
